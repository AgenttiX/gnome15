...
class G15Screen:
    ...
    @staticmethod
    def should_reconnect(exception):
    ...
    def screen_cycle(self):
        ...
        if page is not None and page.priority < PRI_HIGH:
            self.cycle(1)
        else:
            self.resched_cycle()
    ...
    def resched_cycle(self, arg1=None, arg2=None, arg3=None, arg4=None):
        ...
        try:
            ...
            active = self.driver is not None and self.driver.is_connected() and cycle_screens
            if active and self.cycle_timer is None:
    ...
    def driver_changed(self, client, connection_id, entry, args):
        if self.reconnect_timer:
            self.reconnect_timer.cancel()
        if self.driver is None or self.driver.id != entry.value.get_string():
    ...
    def has_page(self, page):
        return self.get_page(page.id) is not None
    ...
    def _draw_page(self, visible_page, direction="down", transitions=True, redraw_content=True):
        ...
        try:
            ...
            if self.visible_page is not None:
                ...
                if self.content_surface is None or redraw_content:
            ...
            # Run any transitions
            if transitions and self.transition_function is not None and self.old_canvas is not None:
            ...
            if self.painter_function is not None:
    ...
    def _do_redraw(self, page=None, direction="up", transitions=True, redraw_content=True):
        ...
        try:
            ...
            elif page is not None and page.panel_painter is not None:
