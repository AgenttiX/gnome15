...
def get_float_or_default(gconf_client, key, default=None):
    ...
    return default if float_val is None else float_val.get_float()
...
def get_string_or_default(gconf_client, key, default=None):
    ...
    return default if str_val is None else str_val.get_string()
...
def get_bool_or_default(gconf_client, key, default=None):
    ...
    return default if bool_val is None else bool_val.get_bool()
...
def get_int_or_default(gconf_client, key, default=None):
    ...
    return default if int_val is None else int_val.get_int()
...
def get_rgb_or_default(gconf_client, key, default=None):
    ...
    return default if val is None or val == "" else _to_rgb(val)
...
def _to_rgb(string_rgb, default=None):
    ...
    if string_rgb is None or string_rgb == "":
        return default
