...
g19_lcd_brightness_control = g15driver.Control("lcd_brightness", _("LCD Brightness"), 100, 0, 100,
...
g110_keyboard_backlight_control = g15driver.Control(
    "backlight_colour", _("Keyboard Backlight Colour"), (255, 0, 0),
...
controls = {
    ...
    g15driver.MODEL_G19: [g19_mkeys_control, g19_keyboard_backlight_control, g19_lcd_brightness_control,
                          g19_foreground_control, g19_background_control, g19_highlight_control],
...
class Driver(g15driver.AbstractDriver):
    ...
    def redraw(self):
        if self.image is not None and self.main_window is not None:
    ...
    def _draw_surface(self):
        ...
        width = self.lcd_size[0]
        height = self.lcd_size[1]
        if self.area is not None and self.area.window is not None:
