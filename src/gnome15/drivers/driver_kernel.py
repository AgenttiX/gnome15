...
class Driver(g15driver.AbstractDriver):
    ...
    def __init__(self, device, on_close=None):
        ...
        try:
            ...
            if self.device_name is not None and self.device_name != "" or self.device_name != "auto":
    ...
    def is_connected(self):
        return self.system_service is not None
    ...
    def get_model_name(self):
        return self.device.model_id if self.device is not None else None
    ...
    def get_controls(self):
        return self.device_info.controls if self.device_info is not None else None
    ...
    def _on_connect(self):
        ...
        if self.device.bpp != 0:
            if self.fb_mode is None or self.device_name is None:
