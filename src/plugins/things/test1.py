...
class Exit(Thing):
    def __init__(self, app):
        ...
        self.stops(".......................................................................................^")
        self.funcs("^.....................................................................................^",
                   (BACKDROP.goStop, 3), app.quit)

        class EndScarab(Thing):
            def __init__(self):
                Thing.__init__(self)
                self.keys("#----------------------------------#---------------------------#", Props(),
                          Props(sz=6, rot=pi), Props(a=0, rot=pi2))
                self.loops = False
                self.add(SCARABsh)
    ...
    def __init__(self):
        ...
        class NextButton(ButtonThing):
            ...
            def __init__(self):
                ...
                self.addStates(
                    {"normal": ArrowButtonN(), "over": ArrowButtonO(), "down": ArrowButtonD(), "up": ArrowButtonU()})
...
class BlueBox(Thing):
    ...
    def draw(self, ctx, fr):
        ...
        ctx.set_source_rgb(
            *CAIROBLUE)  # The * means make a list of CAIROBLUE -- so it's passed into the func as three params!
        ctx.stroke_preserve()
