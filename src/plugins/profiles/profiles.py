...
class G15Profiles(g15plugin.G15MenuPlugin):
    ...
    def __init__(self, gconf_client, gconf_key, screen):
        g15plugin.G15MenuPlugin.__init__(self, gconf_client, gconf_key, screen, ["user-bookmarks", "bookmarks"], id,
                                         _("Profiles"))
    ...
    @staticmethod
    def _configure_profile_with_window_name(profile, window_name):
