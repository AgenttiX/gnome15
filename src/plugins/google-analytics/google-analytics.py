...
class G15VisitsGraph(g15theme.Component):
    ...
    def paint(self, canvas):
        ...
        if self.view_bounds:
            ...
            plot.label_color = self.plugin._screen.driver.get_color_as_ratios(g15driver.HINT_FOREGROUND,
                                                                              (255, 255, 255))
            plot.shadow = True
...
class G15GoogleAnalytics:
    def __init__(self, gconf_key, gconf_client, screen):
        ...
        self._icon_path = g15icontools.get_icon_path(
            ["redhat-office", "package_office", "gnome-applications", "xfce-office", "baobab"])
    ...
    def _paint_thumbnail(self, canvas, allocated_size, horizontal):
        if self._page is not None and self._thumb_icon is not None and self._screen.driver.get_bpp() == 16:
