...
g15devices.g15_action_keys[SCREENSHOT] = g15actions.ActionBinding(SCREENSHOT, [g15driver.G_KEY_MR],
                                                                  g15driver.KEY_STATE_HELD)
g15devices.g19_action_keys[SCREENSHOT] = g15actions.ActionBinding(SCREENSHOT, [g15driver.G_KEY_MR],
                                                                  g15driver.KEY_STATE_HELD)
...
unsupported_models = [g15driver.MODEL_G110, g15driver.MODEL_G11, g15driver.MODEL_MX5500, g15driver.MODEL_G930,
                      g15driver.MODEL_G35, g15driver.MODEL_Z10]
actions = {
...
class LCDShotPreferences:
    def __init__(self, parent, driver, gconf_client, gconf_key):
        ...
        bg_img = g15gconf.get_string_or_default(self.gconf_client, "%s/folder" % self.gconf_key,
        ...
        g15uigconf.configure_combo_from_gconf(self.gconf_client, "%s/mode" % self.gconf_key, "Mode", "still",
                                              widget_tree)
...
class G15LCDShot:
    ...
    def _encode(self):
        ...
        try:
            ...
            if ret == 0:
                g15notify.notify(_("LCD Screenshot"), _("Video encoding complete. Result at %s" % self._record_to),
                                 "dialog-info", timeout=0)
            ...
            g15notify.notify(_("LCD Screenshot"), _("Video encoding failed. Do you have mencoder installed?"),
                             "dialog-error", timeout=0)
