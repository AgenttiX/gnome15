...
class G15Backlight:
    ...
    def activate(self):
        self.page = g15theme.G15Page(id, self.screen, theme_properties_callback=self._get_theme_properties,
                                     priority=g15screen.PRI_LOW, title=name, theme=g15theme.G15Theme(self),
    ...
    def _value_changed(self, widget, octet):
        ...
        self.gconf_client.set_string("/apps/gnome15/" + backlight_control.id,
