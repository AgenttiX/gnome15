...
g15devices.g15_action_keys[SELECT_PROFILE] = g15actions.ActionBinding(SELECT_PROFILE, [g15driver.G_KEY_L1],
                                                                      g15driver.KEY_STATE_HELD)
g15devices.z10_action_keys[SELECT_PROFILE] = g15actions.ActionBinding(SELECT_PROFILE, [g15driver.G_KEY_L1],
                                                                      g15driver.KEY_STATE_HELD)
g15devices.g19_action_keys[SELECT_PROFILE] = g15actions.ActionBinding(SELECT_PROFILE, [g15driver.G_KEY_BACK],
                                                                      g15driver.KEY_STATE_HELD)
...
class ResolutionMenuItem(g15theme.MenuItem):
    ...
    def activate(self):
        os.system("xrandr --auto --output %s --mode %sx%s -r %s" % (
        self.display, self.size[0], self.size[1], self.refresh_rate))
...
class G15XRandR(g15plugin.G15MenuPlugin):
        ...
        if status == 0:
            ...
            for line in output.split('\n'):
                ...
                if line.startswith("  "):
                    ...
                    i += 1
                    display = arr[0]
                    item = g15theme.MenuItem("display-%s" % i, True, arr[0], activatable=False,
    ...
    @staticmethod
    def _differs(old_active, new_active):
